  ...
  // Navbar Dark / Light Layout Toggle Switch
    ...
    if (currentLayout !== 'dark-layout') {
      // Switch to dark
        ...
        setCookie("dark-mode-layout", "dark-layout");
        setCookie("dark-mode-navbar", "navbar-light");
        setCookie("dark-mode-menue", "menu-dark");

        setCookie("light-mode-layout", "");
        setCookie("light-mode-navbar", "");
        setCookie("light-mode-menue", "");
        
    } else {
      // Switch to light
        switchToLayout = 'light-layout';
        setCookie("light-mode-layout", "light-layout");
        setCookie("light-mode-navbar", "navbar-light");
        setCookie("light-mode-menue", "menu-light");

        setCookie("dark-mode-layout", "");
        setCookie("dark-mode-navbar", "");
        setCookie("dark-mode-menue", "");
