    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<RequestLocalizationOptions>(opts =>
            {
                ...
                cp.CookieName = "GPS.Lang.Web.Agent.Cookie";
            });
            ...
            services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
                .AddCookie(options =>
                {
                    options.Cookie.Name = "GPS.Web.Agent.Cookie";
            ...
            services.AddScoped<ICustomAlertService, CustomAlertService>();
            ...
            services.AddRefitClient<IOnlineInventoryHistoryApiProxy>()
                      .ConfigureHttpClient(c =>
                      {
                          c.BaseAddress = new Uri(appSettings.WebApi.BaseUrl);
                          c.DefaultRequestHeaders.TryAddWithoutValidation("api-key", appSettings.WebApi.ApiKey);
            ...
            services.AddRefitClient<IInventoryHistoryReportApiProxy>()
                    .ConfigureHttpClient(c =>
                    {
                        c.BaseAddress = new Uri(appSettings.WebApi.BaseUrl);
                        c.DefaultRequestHeaders.TryAddWithoutValidation("api-key", appSettings.WebApi.ApiKey);
            ...
            services.AddRefitClient<IAlertApiProxy>()
                    .ConfigureHttpClient(c =>
                    {
                        c.BaseAddress = new Uri(appSettings.WebApi.BaseUrl);
                        c.DefaultRequestHeaders.TryAddWithoutValidation("api-key", appSettings.WebApi.ApiKey);
