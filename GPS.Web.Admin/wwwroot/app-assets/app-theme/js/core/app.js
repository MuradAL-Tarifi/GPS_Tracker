  ...
  // Navbar Dark / Light Layout Toggle Switch
    ...
    if (currentLayout !== 'dark-layout') {
      // Switch to dark
        ...
        setCookie("dark-mode-layout-admin", "dark-layout");
        setCookie("dark-mode-navbar-admin", "navbar-light");
        setCookie("dark-mode-menue-admin", "menu-dark");

        setCookie("light-mode-layout-admin", "");
        setCookie("light-mode-navbar-admin", "");
        setCookie("light-mode-menue-admin", "");
        
    } else {
      // Switch to light
        switchToLayout = 'light-layout';
        setCookie("light-mode-layout-admin", "light-layout");
        setCookie("light-mode-navbar-admin", "navbar-light");
        setCookie("light-mode-menue-admin", "menu-light");

        setCookie("dark-mode-layout-admin", "");
        setCookie("dark-mode-navbar-admin", "");
        setCookie("dark-mode-menue-admin", "");
